        ...
        <div class="col-md-12 col-xs-12">
            <div class="row">
                <div class="col-md-3 animated bounceInLeft">
                    <h2><a href="{{route('slids.create')}}" data-toggle="tooltip" data-placement="top"
                           title="Novo Slide"><i class="fa fa-plus" aria-hidden="true"></i></a></h2>
                </div>
