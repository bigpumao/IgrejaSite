...
<div class="col-md-12">
    ...
    <div class="row borda">
        <div class="col-md-2">
            <img src="/imagens/logo/logo.png"  alt="" width="150" heigth="150">
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-4">
            @if(Request::route()->getName()== "membro.create")
            <img src="/imagens/membros/avatar.jpg" name="imagem" alt="" width="100px" heigth="100px">
            @else
            <img src="/imagens/membros/{{$membro->imagem}}" name="imagem" alt="" width="100px" heigth="100px">
            @endif     
    ...
    <div class="row" style="margin-top:50px;">
        ...
        <div class="row">
            <div class="col-md-12">
                {!! Form::label('historico', 'Histórico | Observações', ['class'    =>  'control-label']) !!}

                {!! Form::textarea('historico', null, ['class'  =>  'form=control form-control input-transparent', 'rows'  =>  '15',   'cols'  =>  '150']) !!}
                {{--<textarea name="historico" rows="15" cols="150" class="form-control input-transparent" id="content"></textarea>--}}
