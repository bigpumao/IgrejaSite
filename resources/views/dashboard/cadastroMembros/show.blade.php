        ...
        <div class="col-md-offset-2 col-md-8">
            <div class="row">
                <div class="col-md-3 pull-right">
                    ...
                    <a href="/imagem/igreja/membros/avatar.jpg" data-lightbox="image-1" data-title="{{$membro->nome}}"><img src="/imagens/membros/avatar.jpg" width="200" height="200"></a>
                    @else
                    <a href="/imagem/igreja/membros/{{$membro->imagem}}" data-lightbox="image-1" data-title="{{$membro->nome}}"><img src="/imagens/membros/{{$membro->imagem}}" width="200" height="200"></a>
                     @endif
                </div>
            </div>
            <div class="row">
