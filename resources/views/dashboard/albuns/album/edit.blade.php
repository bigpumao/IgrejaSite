...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <img class="img-bordered img pull-right" src="/imagens/album/capa_album/{{$album->imagem_capa}}">
    ...
    <div class="row">
        @if(Session::has('errors'))
            @foreach($errors->all() as $error)
               <div class="col-md-6">
                   <li id="msg" class="alert alert-danger">{{$error}}</li>
               </div>
            @endforeach
        @endif
    </div>
    <div class="row margin">
        ...
        <div class="col-md-6">
            <label for="nome" class="control-label">Status</label>
            {!! Form::select('status', [
            '0'=>   'Inativo',    '1'   =>  'Ativo',
            ],
    ...
    <div class="row margin">
        <div class="col-md-6">
            <label for="nome" class="control-label">Departamento</label>
