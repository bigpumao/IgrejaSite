...
class Loader
{
    ...
    /**
     * Sets the base script path for all class files in the namespace of this class loader.
     *
    ...
    /**
     * Gets the base script path for all class files in the namespace of this class loader.
     *
     ...
     *
     * @param string $fileName relative to script path.
     * @return string
     */
