...
EOT;
    ...
    *** START: FULL LICENSE ***
    ...
    devised. The above rights script the right to make such modifications
    ...
    of this License. You must script a copy of, or the Uniform Resource
    ...
    the following provisions: (I) You must script a copy of, or the URI
