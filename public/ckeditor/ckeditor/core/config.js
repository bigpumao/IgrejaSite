...
CKEDITOR.config = {
	 ...
	 * as the section that will script the contents. In this way ID-specific CSS rules will
	 * be enabled.
	 *
	 ...
	 * as the section that will script the contents. In this way class-specific CSS rules will
	 * be enabled.
	 *
