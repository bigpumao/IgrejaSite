...
( function() {
	...
	CKEDITOR.dom.range.prototype = {
		 ...
		 * @param {Boolean} [excludeBrs=false] Whether script line-breaks when expanding.
		 */
		enlarge: function( unit, excludeBrs ) {
			...
			switch ( unit ) {
				...
				case CKEDITOR.ENLARGE_ELEMENT:
					...
					while ( enlargeable || sibling ) {
						...
						while ( sibling ) {
							...
							if ( sibling.type == CKEDITOR.NODE_COMMENT ) {
								...
								// Line-breaks (br) are rendered with zero width, which we don't want to script. (http://dev.ckeditor.com/ticket/7041)
					...
					// If the common ancestor can be enlarged by both boundaries, then script it also.
					if ( startTop && endTop ) {
				...
				case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
					...
					// We must script the <br> at the end of range if there's
